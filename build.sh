...
while [[ $# -gt 0 ]]; do
   ...
   -c | --crossbuild)
      ...
      *)
      ...
      docker buildx build --platform linux/amd64,linux/arm64/v8 -t spurin/webtop-k8s:latest . --push
      exit
      ;;
   -cr | --crossbuildremote)
      echo "Do you wish to overwrite the live image?, Enter Yes to overwrite"
      ...
      *)
      ...
      docker buildx build --platform linux/amd64,linux/arm64/v8 -t spurin/webtop-k8s . --push
      exit
      ;;
   *)
